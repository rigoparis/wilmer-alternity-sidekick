...
func _on_theme_changed() -> void:
	if has_node("/root/ThemeManager"):
		...
		var header_btns = [theme_btn, optional_rules_button, share_char_button, close_char_button]
			...
			if btn != null:
				...
				for state in ["normal", "hover", "pressed", "focus", "disabled"]:
					...
					if original_style is StyleBoxFlat:
						...
						dup_style.content_margin_left = 4
						dup_style.content_margin_right = 4
						dup_style.content_margin_top = 4
						dup_style.content_margin_bottom = 4
