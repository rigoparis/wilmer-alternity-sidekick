...
func mutation_distribution_id(character: Dictionary, kind: String) -> String:
	...
	var order = _get_parent().MUTATION_DRAWBACK_TIERS if kind == "drawback" else _get_parent().MUTATION_ADVANTAGE_TIERS
...
func mutation_distribution_label(character: Dictionary, kind: String) -> String:
	var distribution := mutation_distribution(character, kind)
	var order = _get_parent().MUTATION_DRAWBACK_LABEL_ORDER if kind == "drawback" else _get_parent().MUTATION_ADVANTAGE_LABEL_ORDER
