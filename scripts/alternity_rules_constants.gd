...
const SPECIALTY_SUMMARIES := {
	...
	86: "Reading physical evidence: wounds, remains, residues and trace materials, and reconstructing what happened from them.",
	87: "Formal medical training short of surgery: diagnosis, disease, pharmacology, and knowing what a set of symptoms means.",
	...
	147: "Convincing someone of something untrue -- a false identity, a false account, a confidence that will not survive scrutiny.",
	148: "Offering an inducement without it being refused or reported, and judging what a given person can be bought for.",
	149: "Choose a specific game when buying this specialty. Covers play, odds, reading opponents and spotting a cheat.",
